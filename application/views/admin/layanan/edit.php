...
?>
	...
	<div class="col-md-12">
		<div class="form-group form-group-md">
			...
			<textarea name="isi_layanan" id="isi_layanan" class="form-control tinymce" placeholder="Isi Layanan"><?php echo $layanan->isi_layanan ?></textarea>
		</div>


		<div class="form-group form-group-md">
			<label for="keywords">Keyword</label>
			<input type="text" name="keywords" id="keywords" class="form-control" placeholder="Keywords" value="<?php echo $layanan->keywords ?>">
		</div>

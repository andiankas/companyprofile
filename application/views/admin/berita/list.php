            ...
            <div class="box-body">
              ...
              <p>
                <a href="<?php echo base_url('admin/berita/tambah') ?>" title="Tambah Berita" class="btn btn-primary"><i class="fa fa-plus"></i>Tambah Baru</a>
              </p>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td><?php echo $i++; ?></td>
                  <td><img src="<?php echo base_url('assets/upload/image/thumbs/'.$berita->gambar) ?>" width="60px" class="img img-thumbnail"></td>
